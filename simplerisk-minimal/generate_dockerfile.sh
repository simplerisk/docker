...
case "$release" in
  testing|[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]-[0-9][0-9][0-9]) : ;;
  *) echo "Invalid release '$release' (expected YYYYMMDD-NNN or 'testing'). Aborting." && exit 1 ;;
esac
...
RUN sh /download_and_verify_bundle.sh $release
